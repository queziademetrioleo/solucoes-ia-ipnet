{
  ...
  description: "Execução contínua de roadmap de IA com responsabilidade real por entrega em produção.",
  iconName: "Users",
  details: {
    timeline: "Mínimo 3 meses",
    context: "Empresas possuem backlog de IA validado, mas enfrentam gargalo de execução por falta de senioridade técnica e capacidade interna.",
    
    positioning: "Não oferecemos alocação de recursos. Oferecemos capacidade estruturada de execução contínua em IA com accountability por entrega.",
    ...
    artifacts: [
      { 
        ...
        description: "Features de IA em produção com testes automatizados e versionamento estruturado.", 
        type: "technical" 
      },
      { 
        name: "Relatório Quinzenal", 
        description: "Progresso de sprint, métricas técnicas e indicadores de impacto.", 
        type: "management" 
      },
      { 
        name: "Documentação Arquitetural", 
        description: "ADRs, runbooks e plano de autonomia técnica.", 
        type: "technical" 
      }
    ],

    architectureDescription: "Integração total com os processos ágeis do cliente (Scrum/Kanban), com governança técnica, MLOps estruturado e foco em produção.",
    ...
    contractModel: {
      ...
      scalability: "Possibilidade de expandir ou reduzir o squad conforme necessidade"
    }
  }
}